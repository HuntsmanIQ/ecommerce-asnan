      ...
      child: Row(
        ...
        children: [
          ...
          Consumer<WishlistPresenter>(
            ...
            builder: (context, wishlistPresenter, child) {
              return Button(
                  onPressed: () {
                    if (SystemData.isLogIn) {
                      if (wishlistPresenter.isAddedWishlist) {
                        wishlistPresenter.deleteWishlist(
                            data.productInfo!.id, context);
                      } else {
                        wishlistPresenter.addWishlist(
                            data.productInfo!.id, context);
                      }
                    } else {
                      MakeRoute.go(context, const Login());
                  ...
                  child: Icon(
                    wishlistPresenter.isAddedWishlist
                        ? Icons.favorite
          ...
          Button(
            ...
            onPressed: () {
              if (SystemData.isLogIn) {
                if (data.selectedVariation!.sock > 0) {
                  Provider.of<CartPresenter>(context, listen: false).addToCart(
                      data.selectedVariation!.id, data.quantity, context);
                } else {
            ...
            child: Text(
              AppLang.local(context).add_to_cart,
    ...
    return Container(
      ...
      child: Column(
        children: [
          CarouselSlider(
            items:
                data.isProductInfoInitial ? buildImages(data) : sliderShimmer(),
