                  ...
                  if (orderPresenter.trackInfo != null)
                    Column(
                      ...
                      children: [
                        ...
                        Container(
                          decoration: BoxDecorations.shadow(radius: 5).copyWith(
                                    ...
                                    child: Row(
                                      children: [
                                        SizedBox(
                                            width: getWidth(context) * 0.25,
                                            child: Text(orderPresenter
                                                    .trackInfo?.createdDate ??
                                                "")),
                                        SizedBox(
                                            width: getWidth(context) * 0.55,
                                            child: Text(AppLang.local(context)
