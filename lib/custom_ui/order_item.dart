      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              "${item.qty} x ${showPrice(item.product?.price.toString() ?? '')}",
                ...
                Button(
                    ...
                    onPressed: () {
                      ...
                      Provider.of<RefundPresenter>(context, listen: false)
                          .refundReq(
                              this.context, item.id, controller.text.trim())
                          .then(
                              (value) => onReq != null ? onReq!(value) : null);
                    },
                    child: Text(
                      AppLang.local(context).submit,
                      style: StyleConfig.fs12cWhite,
                    ))
              ],
            ));
  }
